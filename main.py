...
def main():        
    ...
    logfile = f"logs/logfile_worker{args.index}of{args.workers}_{right_now}.log"
    resultsfile = f"results/results_worker{args.index}of{args.workers}_{right_now}.log"
